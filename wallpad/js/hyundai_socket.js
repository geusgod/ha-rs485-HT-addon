...
const CONST = {
  ...
  DEVICE_STATE: [
    ...
    //                                                       F7 0B 01 19 01 40 11 00 00 B4 EE    F7 0B 01 19 04 40 11 00 02 B3 EE
    ...
    { base_topic: 'light/homenet/panel1-4', statePrefixHex: 'f7 0b 01 19 04 40 14'.toBuffer(), checkState: checkStateSingleValue, stateIndex:  8, stateCode: 0x02, stateName: 'power', state: 'OFF' },
    { base_topic: 'light/homenet/panel1-4', statePrefixHex: 'f7 0b 01 19 04 40 14'.toBuffer(), checkState: checkStateSingleValue, stateIndex:  8, stateCode: 0x01, stateName: 'power', state:  'ON' },
    { base_topic: 'light/homenet/panel1-5', statePrefixHex: 'f7 0b 01 19 04 40 15'.toBuffer(), checkState: checkStateSingleValue, stateIndex:  8, stateCode: 0x02, stateName: 'power', state: 'OFF' },
    { base_topic: 'light/homenet/panel1-5', statePrefixHex: 'f7 0b 01 19 04 40 15'.toBuffer(), checkState: checkStateSingleValue, stateIndex:  8, stateCode: 0x01, stateName: 'power', state:  'ON' },
  ...
  DEVICE_COMMAND: [
    ...
    //                                                   F7 0B 01 19 02 40 11 02 00 B5 EE                       F7 0B 01 19 04 40 11 02 02 B1 EE 
    ...
    //                                                   F7 0B 01 19 02 40 11 01 00 B6 EE                       F7 0B 01 19 04 40 11 01 01 B1 EE
    ...
    { base_topic: 'light/homenet/panel1-4', commandHex: 'f7 0b 01 19 02 40 14 02 00 b7 ee'.toBuffer(), ackHex: 'f7 0b 01 19 04 40 14 02 02 b4'.toBuffer(), stateName: 'power', state: 'OFF' },
    { base_topic: 'light/homenet/panel1-4', commandHex: 'f7 0b 01 19 02 40 14 01 00 b4 ee'.toBuffer(), ackHex: 'f7 0b 01 19 04 40 14 01 01 b4'.toBuffer(), stateName: 'power', state:  'ON' },
    { base_topic: 'light/homenet/panel1-5', commandHex: 'f7 0b 01 19 02 40 15 02 00 b7 ee'.toBuffer(), ackHex: 'f7 0b 01 19 04 40 15 02 02 b5'.toBuffer(), stateName: 'power', state: 'OFF' },
    { base_topic: 'light/homenet/panel1-5', commandHex: 'f7 0b 01 19 02 40 15 01 00 b4 ee'.toBuffer(), ackHex: 'f7 0b 01 19 04 40 15 01 01 b5'.toBuffer(), stateName: 'power', state:  'ON' },
  ...
  DEVICE_SCHEDULED_REQUEST: [
    ...
    { category: 'light/homenet/panel1-4', requestHex: 'f7 0b 01 19 01 40 14 00 00 b1 ee'.toBuffer(), lastActivity: new Date().getTime() + 1000, lastDelegateActivity: new Date().getTime() + 1000 },
    { category: 'light/homenet/panel1-5', requestHex: 'f7 0b 01 19 01 40 15 00 00 b0 ee'.toBuffer(), lastActivity: new Date().getTime() + 1000, lastDelegateActivity: new Date().getTime() + 1000 },
...
var humanizeBuffer = buffer => [buffer.toString('hex', 0, 1), buffer.toString('hex', 1, 2), buffer.toString('hex', 2, 3),  buffer.toString('hex', 3, 4), buffer.toString('hex', 4, 5), buffer.toString('hex', 5, 6), buffer.toString('hex', 6, 7), buffer.toString('hex', 7)].join(' ');
